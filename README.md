...
Rewrite the code to run on GPUs, making an effort to ensure that the code runs as efficiently as possible.
...
Your response to this task should be fairly extensive (likely >1000 words).
